...
[BeatklinkTriggerのダウンロードリンク](https://github.com/Deep-Symmetry/beat-link-trigger/releases)
...
| :--- | ---: |
| Watch | Master Player |
| Midi Output | XDJ-XZ(1) or XDJ-XZ(2) |
| Message | Custom / 127 |
| Channel | 1 |
...
各チャンネルにプリセットを読み込むか、手動で各カラーブロックに色を設定してください。既存のプリセットはpresetフォルダの中にあります。
...
基本の使い方は以上です。
多分定期的にバグって動作がおかしくなると思うんでその時はプログラム本体を強制再起動してください。
